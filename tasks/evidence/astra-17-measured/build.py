...
root=Path.cwd();out=root/'tasks/evidence/astra-17-measured'
...
(root/'tasks/evidence/astra-17-measured/source.patch').write_bytes(subprocess.check_output(['git','diff']))
