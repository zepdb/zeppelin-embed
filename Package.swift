...
// local mismatch.
let binaryChecksum = "7add003de4dbac72f10fb1ef8ffb3f14712b8c0dd9287b610c00c19f822b336a" // ze:xcframework-checksum
...
if useLocalFFI {
    ...
    cTarget = .binaryTarget(
        name: "CZeppelinEmbed",
        url: "https://github.com/zepdb/zeppelin-embed/releases/download/v0.4.2/ZeppelinEmbed.xcframework.zip",
